...
**Development Head:** `pip install git+https://github.com/allen-cell-animated/py_bg_bootstrap.git`

## Documentation
For full package documentation please visit [allen-cell-animated.github.io/py_bg_bootstrap](https://allen-cell-animated.github.io/py_bg_bootstrap).
...
* Turn your project into a GitHub repository:
  ...
  * After a GitHub repo has been created, run the following commands:
    * `git remote add origin git@github.com:allen-cell-animated/py_bg_bootstrap.git`
...
* Register py_bg_bootstrap with Codecov:
  ...
  * Copy the token provided, go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/allen-cell-animated/py_bg_bootstrap/settings/secrets),
...
generation to work
  ...
  * Go to your [GitHub repository's settings and under the `Secrets` tab](https://github.com/allen-cell-animated/py_bg_bootstrap/settings/secrets),
...
* Add branch protections to `master` and `stable`
    * To protect from just anyone pushing to `master` or `stable` (the branches with
    ...
    configurations)
    * Go to your [GitHub repository's settings and under the `Branches` tab](https://github.com/allen-cell-animated/py_bg_bootstrap/settings/branches), click `Add rule` and select the
